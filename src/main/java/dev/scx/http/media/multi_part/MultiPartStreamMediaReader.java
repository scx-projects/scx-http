...
public final class MultiPartStreamMediaReader implements MediaReader<MultiPartStream> {
    ...
    public static String checkedBoundary(ScxMediaType mediaType) throws IllegalArgumentException, BadRequestException {
    ...
    @Override
    public MultiPartStream read(ByteInput byteInput, ScxMediaType mediaType) throws ScxIOException, AlreadyClosedException, BadRequestException {

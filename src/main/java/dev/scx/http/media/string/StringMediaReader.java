...
import dev.scx.http.media_type.IllegalMediaTypeException;
...
public final class StringMediaReader implements MediaReader<String> {
    ...
    public static Charset getCharsetOrUTF8(ScxMediaType mediaType) throws IllegalMediaTypeException {
        if (mediaType != null) {
    ...
    @Override
    public String read(ByteInput byteInput, ScxMediaType mediaType) throws ScxIOException, AlreadyClosedException, IllegalMediaTypeException {

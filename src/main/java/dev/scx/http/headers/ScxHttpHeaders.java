...
import dev.scx.http.headers.content_length.ContentLength;
...
public interface ScxHttpHeaders extends Parameters<ScxHttpHeaderName, String> {
    ...
    default ScxMediaType contentType() throws IllegalMediaTypeException {
    ...
    default Long contentLength() throws IllegalContentLengthException {
        ...
        return c != null ? ContentLength.of(c) : null;
    }

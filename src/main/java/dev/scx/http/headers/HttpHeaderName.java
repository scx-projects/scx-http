...
public enum HttpHeaderName implements ScxHttpHeaderName {
    ...
    /// @return 未找到 抛出异常
    public static HttpHeaderName of(String headerName) throws IllegalArgumentException {
        var h = find(headerName);
        if (h == null) {
            throw new IllegalArgumentException("Unknown HeaderName: " + headerName);
        }
        return h;
    }
    ...
    /// @param headerName headerName
    /// @return 未找到返回 null
    public static HttpHeaderName find(String headerName) {
        var lowerCase = headerName.toLowerCase();

...
public interface Accept extends Iterable<MediaRange> {
    ...
    static AcceptWritable parse(String acceptStr) throws IllegalMediaRangeException {
        return AcceptHelper.parseAccept(acceptStr);
    }
    ...
    default String encode() {
        return AcceptHelper.encodeAccept(this);
    }

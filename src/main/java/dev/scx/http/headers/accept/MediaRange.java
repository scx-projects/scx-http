...
public interface MediaRange {
    ...
    static MediaRangeWritable of(String type, String subtype) {
        return new MediaRangeImpl(type, subtype);
    }

    static MediaRangeWritable of(String type) {
        return new MediaRangeImpl(type, "*");
    }
    ...
    static MediaRangeWritable parse(String mediaRangeStr) throws IllegalMediaRangeException {
    ...
    default String encode() {
        return MediaRangeHelper.encodeMediaRange(this);
    }

...
import dev.scx.collection.multi_map.MultiMapEntry;
...
public class ParametersIterator<K, V> implements Iterator<ParameterEntry<K, V>> {
    ...
    protected final Iterator<MultiMapEntry<K, V>> iterator;

    public ParametersIterator(Iterator<MultiMapEntry<K, V>> iterator) {

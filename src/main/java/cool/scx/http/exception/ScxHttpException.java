...
public class ScxHttpException extends RuntimeException {
    ...
    public ScxHttpException(ScxHttpStatusCode statusCode) {
        super();
        this.statusCode = statusCode;
    }

    public ScxHttpException(ScxHttpStatusCode statusCode, String message) {
        super(message);
        this.statusCode = statusCode;
    }

    public ScxHttpException(ScxHttpStatusCode statusCode, Throwable cause) {
        super(cause);
        this.statusCode = statusCode;
    }

    public ScxHttpException(ScxHttpStatusCode statusCode, String message, Throwable cause) {
        super(message, cause);
        this.statusCode = statusCode;
    }

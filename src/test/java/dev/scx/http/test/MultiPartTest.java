...
public class MultiPartTest {
    ...
    public static void test1() throws IOException {
        ...
        for (int j = 0; j < 9999; j = j + 1) {
            ...
            MultiPart read = MULTI_PART_STREAM_MEDIA_READER.read(s, ScxMediaType.of(MediaType.MULTIPART_FORM_DATA).boundary("wwwwwwwwww"));
    ...
    public static void test2() {
        ...
        MultiPartStream read = MULTI_PART_STREAM_MEDIA_READER.read(s, ScxMediaType.of(MediaType.MULTIPART_FORM_DATA).boundary("wwwwwwwwww"));

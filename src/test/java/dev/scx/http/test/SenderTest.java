...
public class SenderTest {
    ...
    public static void main(String[] args) throws IllegalSenderStateException {
        test1();
        test2();
    }

    @Test
    public static void test1() throws IllegalSenderStateException {
    ...
    @Test
    public static void test2() throws IllegalSenderStateException {
        var sender = new TestHttpSender(ScxHttpHeaders.of(), ScxHttpHeaders.of());
    ...
    public static class TestHttpSender implements ScxHttpMediaSender<TestHttpSender> {
        ...
        @Override
        public TestHttpSender send(BodyWriter bodyWriter) throws IllegalSenderStateException, ScxIOException, AlreadyClosedException {
